			...
			<div className="code-conduct">
				...
				<div className="code-conduct__container">
					...
					<div className="code-conduct__content">
						...
						<div className="code-conduct__text">
							<p>Posters should be in landscape format and should be uploaded as a single PDF file. The recommended poster size is A0 (118 x 84 cm), with the title in size 100 font. An example can be found <a href="" target="_blank">here</a></p>
						</div>
					</div>
					<div className="code-conduct__content">
					...
					<div className="code-conduct__content">
						...
						<div className="code-conduct__text">
							<p>Please upload your poster or presentation using this <a href="https://forms.gle/bM5cAWSSnYcJDczN8" target="_blank">Google Form</a>.</p><p><span>Submissions need to be received no later than Friday, August 20.</span></p>
						</div>
					</div>
					<div className="code-conduct__content">
					...
					<div className="code-conduct__content">
						...
						<div className="code-conduct__text">
							...
							<p>From: <a href="https://www.greatspeech.co/video-presentations/" target="_blank">https://www.greatspeech.co/video-presentations/</a></p>
						</div>
					</div>
					<div className="code-conduct__content">
					...
					<div className="code-conduct__content">
						...
						<div className="code-conduct__text">
							...
							<p>From: <a href="https://www.inxpo.com/assets/pdfs/litepapers/How-To-Be-An-Engaging-Speaker.pdf" target="_blank">https://www.inxpo.com/assets/pdfs/litepapers/How-To-Be-An-Engaging-Speaker.pdf</a></p>
						</div>
					</div>
					<div className="code-conduct__content">
						<h2 className="code-conduct__header">Inclusive Speaker Orientation Online Course</h2>
						<div className="code-conduct__text">
							<p>The Linux Foundation, in collaboration with the National Center for Women in Technology (NCWIT), has created an <a href="https://training.linuxfoundation.org/content/inclusive-speaker-orientation" target="_blank">online course</a> designed to teach the viewer about inclusion, diversity, and unconscious bias. We highly recommend all of our speakers ,<a href="https://training.linuxfoundation.org/content/inclusive-speaker-orientation" target="_blank">watch the course</a> to learn tips/tools to use when speaking to encourage inclusivity in presentations and messaging.</p>
						</div>
					</div>
					<div className="code-conduct__content">
						<h2 className="code-conduct__header">Code of Conduct</h2>
						<div className="code-conduct__text">
							<p>Please read and abide by our code of conduct, which can be found <a href="/code-of-conduct/">here</a>. We ask that speakers especially review this code of conduct and are inclusive in the **words and images** used during their presentation.</p>
						</div>
					</div>
					<div className="code-conduct__content">
						<h2 className="code-conduct__header">Additional Resources</h2>
						<div className="code-conduct__text">
							<p><span><a href="https://www.cnet.com/how-to/best-gear-for-online-meetings-webcams-lights-mics-tripods-and-more/" target="_blank">Best Gear for Online Meetings</a></span> – Webcams, lights, mics, tripods and more</p>
							<p><span><a href="https://www.greatspeech.co/video-presentations/#.XtFN_y_Mx-U">19 Video Presentation Tips</a></span> to help you give a great presentation (even if you hate the way you look on camera)</p>
							<p><span><a href="https://pantheon.io/blog/tips-for-virtual-presentations" target="_blank">9 Tips for Giving Engaging Virtual Presentations</a></span> – This article gives 9 tips and within each tip has folks from the tech world giving their advice in a fun/relatable way.</p>
							<p><span><a href="https://magneticspeaking.com/9-important-tips-for-virtual-presentations/" target="_blank">PACE Acronym for Virtual Presentations</a></span></p>
							<p><span><a href="https://www.blueskyelearn.com/for-presenters-a-virtual-event-checklist/" target="_blank">Checklist for Speakers</a></span> – this article provides checklists applicable for speakers that are live streaming.</p>
						</div>
					</div>
					<div className="code-conduct__content">
